        ...
        <tbody>
          {vendors.map((vendor) => (
            <tr key={vendor.vendorId} className="border-b text-gray-700">
              ...
              <td className="px-2 py-1">{vendor.name}</td>
              ...
              <td className="px-2 py-1 text-gray-700">{vendor.speed?.toFixed(2)}</td>
              <td className="px-2 py-1 text-gray-700">{vendor.price?.toFixed(2)}</td>
